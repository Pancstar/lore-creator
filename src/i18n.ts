...
const en: Strings = {
	...
	"lane.title": "Rename lane",
	"lane.name": "Name",
	"lane.name.desc": "What the lane is called on the canvas. Only a label.",
	"lane.id": "Id",
	"lane.id.desc": "What notes point at. Changing it rewrites the {0} notes in this lane.",
	"lane.save": "Save",
	"lane.saved": "Lane updated",
	"lane.failed": "Could not rename the lane — see the console for details.",
	"lane.idRequired": "The lane needs an id.",
	"lane.idTaken": "Another lane already uses the id {0}.",
	"lane.rename.body": "The id changes from {0} to {1}, and {2} notes are rewritten to match.",
	"lane.hint": "Click to rename",
	"lane.noTimelineNote": "This timeline has no note to store lane names in.",
...
const tr: Strings = {
	...
	"lane.title": "Şeridi yeniden adlandır",
	"lane.name": "Ad",
	"lane.name.desc": "Şeridin tuvalde görünen adı. Sadece etiket.",
	"lane.id": "Kimlik",
	"lane.id.desc": "Notların gösterdiği değer. Değiştirmek bu şerittteki {0} notu yeniden yazar.",
	"lane.save": "Kaydet",
	"lane.saved": "Şerit güncellendi",
	"lane.failed": "Şerit yeniden adlandırılamadı — ayrıntı için konsola bak.",
	"lane.idRequired": "Şeridin bir kimliği olmalı.",
	"lane.idTaken": "{0} kimliğini başka bir şerit kullanıyor.",
	"lane.rename.body": "Kimlik {0} yerine {1} olacak ve {2} not buna göre yeniden yazılacak.",
	"lane.hint": "Yeniden adlandırmak için tıkla",
	"lane.noTimelineNote": "Bu zaman çizgisinin şerit adlarını saklayacağı bir not yok.",
